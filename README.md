...
1. Clone the repository with `git clone https://github.com/VincentHoong/inventory-app-backend.git <your_project_folder_name>`
2. Change directory to your project folder `cd <your_project_folder_name>`
3. Install the dependencies with `npm install`
4. Create database in MySQL.
5. Rename `.env.example` to `.env`
6. Update the your database name and credentials in the `.env` file.
7. Run the application with `npm start` (MySQL service should be up and running).
8. Access `http://localhost:3001` and you're ready to go!
